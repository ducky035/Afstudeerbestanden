...
namespace SharpNeat.Domains._2048
{
    /// <summary>
    /// INeatExperiment for the 2048 game problem domain. 
    /// </summary>
    public class _2048Experiment : IGuiNeatExperiment
    {
        ...
        public void Initialize(string name, XmlElement xmlConfig)
        {
            ...
            _neatGenomeParams = new NeatGenomeParameters
            {
                ...
                ActivationFn = LeakyReLU.__DefaultInstance
            };
        }
        ...
        public NeatEvolutionAlgorithm<NeatGenome> CreateEvolutionAlgorithm(IGenomeFactory<NeatGenome> genomeFactory, List<NeatGenome> genomeList)
        {
            ...
            _2048BlackBoxEvaluator evaluator = new _2048BlackBoxEvaluator();
